...
import { ArrowLeft, Building2, Users, Package, FileText, Calendar, Mail, Phone, MapPin, Save, Clock, AlertTriangle, CheckCircle, Settings, CreditCard } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <Link to={`/admin/tenants/${id}/settings`}>
          <Button variant="outline" className="gap-2">
            <Settings className="w-4 h-4" />
            {isAr ? 'الإعدادات' : 'Settings'}
          </Button>
        </Link>
        <Link to={`/admin/tenants/${id}/subscription`}>
